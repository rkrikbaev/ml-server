...
**"...what happens in each of the 6 steps"**
→ See: TRAINING_PIPELINE_DETAILED_EXPLANATION.md → Steps 1-6
...
```json
{
  "sources": [
    {
      "type": "rest_api",
      "url": "http://datasource.com/api",
      "params": {"object_id": "AKMOLA_LOAD"}
    }
  ],
...
These two documents provide complete coverage of Section 4.2 (Pipeline Steps):
...
Start with: TRAINING_PIPELINE_VISUAL_GUIDES.md for quick overview, then TRAINING_PIPELINE_DETAILED_EXPLANATION.md for complete understanding.
