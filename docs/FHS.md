...
- `src` папке лежат исходный код проекта ML сервера
  - [`api`](./API/MAIN.md) внутри `src` папке лежат файлы API сервера
    ...
    - [`forecast`](./API/FUNCTIONS.md#forecast) внутри `api` папке лежат файлы прогнозирования
    - [`send`](./API/FUNCTIONS.md#send) внутри `api` папке лежат файлы отправки и взятия данных из других серверов
    - [`utils`](./API/FUNCTIONS.md#utils) внутри `api` папке лежат вспомогательные файлы
    - [`broker`](./API/broker/MAIN.md) внутри `api` папке лежат файлы брокера
